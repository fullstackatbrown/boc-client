...
const BigDropdown: React.FC<DropdownProps> = ({ header, content }) => {
  ...
  return (
    <div className="w-full">
      ...
      >
        <span className="font-funky text-2xl desktop:text-3xl text-boc_medbrown mr-2">{header}</span>
        <ChevronDownIcon
      ...
      {/* The old max-h-96 clipped every panel once the content reflowed for narrow screens */}
      <div
