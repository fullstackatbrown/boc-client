...
export default function LandAcknowledgement() {
    return (
        ...
        <div className="h-full min-h-screen w-full">
            ...
            <div>
                <div>
                    <h2 id="paragraph" className="mb-8 text-lg font-light text-left leading-9 italic text-grey-50" style={{ color: '#3b3b3b' }}>
                ...
                <div id="paragraph" className="mt-8 mb-8 text-xl font-[100] text-left leading-10">
                ...
                <div id="paragraph2" className="mt-8 mb-8 text-xl font-[100] text-left leading-10">
                ...
                <div id="paragraph3" className="mt-8 mb-8 text-xl font-[100] text-left leading-10">
